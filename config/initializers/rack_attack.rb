class Rack::Attack
  ...
  ArchiveConfig.RATE_LIMIT_PER_NGINX_UPSTREAM.each do |k, _|
    throttle("req/#{k}/ip", limit: ArchiveConfig.RATE_LIMIT_PER_NGINX_UPSTREAM[k]["limit"], period: ArchiveConfig.RATE_LIMIT_PER_NGINX_UPSTREAM[k]["period"]) do |req|
