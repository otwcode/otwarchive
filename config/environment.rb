...
Rails::Initializer.run do |config|
  ...
  config.active_record.observers = [:user_observer, :comment_observer, :work_observer, :creation_observer, :related_work_observer, :collection_observer]

  # Make Time.zone default to the specified zone, and make Active Record store time values
  # in the database in UTC, and return them converted to the specified local zone.
  # Run "rake -D time" for a list of tasks for finding time zone names. Uncomment to use default local time.
  # config.time_zone = 'Eastern Time (US & Canada)' # does this still produce weird bugs? grr, yes as of Rails 2.3.5
