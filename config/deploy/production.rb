...
server "ao3-app01.ao3.org", :app, :db, :schedulers
server "ao3-app02.ao3.org", :app, :workers, :schedulers
server "ao3-app03.ao3.org", :app, :workers, :schedulers
server "ao3-front01.ao3.org", :web
server "ao3-app16.ao3.org", :web
server "ao3-app05.ao3.org", :app, primary: true
...
server "ao3-app17.ao3.org", :app, :workers
server "ao3-app18.ao3.org", :app, :workers
server "ao3-front05.ao3.org", :web
