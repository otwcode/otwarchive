...
Given /^basic tags$/ do
  ...
  Rating.find_or_create_by_name_and_canonical("General Audiences", true)
  Rating.find_or_create_by_name_and_canonical("Teen And Up Audiences", true)
  Rating.find_or_create_by_name_and_canonical("Mature", true)
