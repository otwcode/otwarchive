...
Scenario: When logged in I can comment on a work, comment threading, comment editing
  ...
  When I follow "Reply"
    And I fill in "Comment" with "I wanted to say more."
    And I press "Add Comment"
  Then I should see "Comment created!"
  ...
  When I follow "Log out" 	
    ...
    And I fill in "Comment" with "Thank you."
    And I press "Add Comment"
  Then I should see "Comment created!"
  ...
  When I am logged out
    ...
    And I fill in "Comment" with "Mistaken comment"
    And I press "Add Comment"
  ...
  When I am logged out
    ...
    And I fill in "Comment" with "This should be nested"
    And I press "Add Comment"
  Then I should see "Comment created!"
    And I should not see "Mistaken comment"
