...
Scenario: Comment threading, comment editing
  ...
  Then I should see "Comment created!"
    And I should see "Thank you." within "li#comment_4.comment.group.odd"
  When I am logged in as "commenter"
    And I view the work "The One Where Neal is Awesome"
    ...
    And I follow "Edit" within "li#edit_comment_link_5"
  ...
  Then I should see "Comment created!"
    And I should not see "Mistaken comment"
    And I should see "Actually, I meant something different" within "li#comment_5.comment.group.even"
    And I should see "I loved it, too." within "li#comment_3.comment.group.even"
    And I should see "Thank you." within ".thread .thread .odd"
    And I should see "This should be nested" within ".thread .thread .thread li#comment_6.comment.group.odd"
    And I should not see "This should be nested" within ".thread .thread .thread .thread"
    And I should see "I loved this" within "li#comment_1.comment.group.odd"
