...
Feature: Prompt Meme Challenge
  ...
  Scenario: Custom request URLs and descriptions are honored in emails

  Given I have custom-labels prompt meme fully set up
  When I am logged in as "myname1"
    And I sign up for Battle 12 with combination E
    And I log out
  When I am logged in as "myname2"
    And I claim a prompt from "Battle 12"
    And I start to fulfill my claim with "Custom Fill"
  When I press "Post"
