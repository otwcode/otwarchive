...
Scenario: fandoms wrangling - syns, mergers, autocompletes, metatags
  ...
  Then I should see "Tag was updated"
    ...
    And the "tag_canonical" checkbox should be checked
  When I follow "Stargate Atlantis"
  Then I should see "Stargate Franchise" within ".tags"
  ...
  Then I should see "Stargate SG-1: Ark of Truth" within ".tags"
    And I should see "Stargate Franchise" within ".tags"
