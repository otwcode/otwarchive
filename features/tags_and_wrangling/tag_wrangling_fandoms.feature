...
Scenario: fandoms wrangling - syns, mergers, autocompletes, metatags
  ...
  Then I should see "Stargate Atlantis" within ".autocomplete"
    And I should see "Stargate SG-1" within ".autocomplete"
  When I fill in "Synonym of" with "Stargate SG-1"
    And I fill in "tag_media_string" with "TV"
    And I should see "TV Shows" within ".autocomplete"
  ...
  Then I should see "Stargates SG-1" within ".autocomplete"
    And I should see "the whole Stargate franchise" within ".autocomplete"
    And I should not see "Stargate SG-1" within ".autocomplete"
  ...
  When I edit the tag "Stargate SG-1"
    And I fill in "MetaTags" with "Stargate Franchise"
    And I should see "Stargate Franchise" within ".autocomplete"
    And I fill in "MetaTags" with "Stargate Franchise"
    And I press "Save changes"
  Then I should see "Tag was updated"
  When I follow "New Tag"
