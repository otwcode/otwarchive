  ...
  Scenario: Subscription emails include HTML in work and chapter summaries in the HTML email and convert it for plain text emails.
  ...
  When "second_user" subscribes to author "first_user"
    ...
    And I press "Post"
    And a chapter is set up for "The First Awesome Story"
    And I fill in "Chapter Summary" with "<p><b>Another</b> HTML summary.</p>"
    And I press "Post"
    And subscription notifications are sent
  Then 1 email should be delivered to "second_user@foo.com"
    ...
    And the email html body should contain "<p><b>Another</b> HTML summary.</p>"
    ...
    And the email text body should not contain "<p><b>Another</b> HTML summary.</p>"
    But the email text body should contain "Paragraph _one_."
    And the email text body should contain "Paragraph 2."
    And the email text body should contain "*Another* HTML summary."
