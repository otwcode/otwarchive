...
Feature: Download a work
  ...
  Then I should see "Downloadable"
    ...
    And I should see "Relationships: Character 1/Character 2 and Character 1 & Character 3"
    And I should see "Characters: Character 1, Character 2, and Character 3"
    And I should see "Additional Tags: Modern AU"
    And I should see "Language: English"
    And I should see "Series: Part 1 of THE DOWN"
    And I should see "Collections: My Collection 1 and My Collection 2"
