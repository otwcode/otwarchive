...
Feature: Download a work
  ...
  Scenario: Hidden external translated works should be hidden in downloads
  ...
  Scenario: Downloads should update when external works get hidden and unhidden
    Given a work inspired by an external work has been posted
    When I log out
      And I view the work "Followup"
      And I follow "HTML"
    ...
    Then I should not see "Worldbuilding by external_inspiration"
    When I am logged in as a "policy_and_abuse" admin
      And I unhide the external work "Worldbuilding"
    When I log out
      And I view the work "Followup"
      And I follow "HTML"
    Then I should see "Worldbuilding by external_inspiration"
