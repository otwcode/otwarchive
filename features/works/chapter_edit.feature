...
Feature: Edit chapters
  ...
  Scenario: Setting chapter position to 1 on new chapter correctly adjusts positions when posting
    Given I am logged in as "karma"
    ...
    When I follow "Add Chapter"
      ...
      And I press "Post"
    Then I should see "Chapter 1"
      And I should see "My New Actual For Real First Chapter"
    When I follow "Next Chapter"
    Then I should see "Chapter 2"
      And I should see "My First Chapter"
  ...
  Scenario: Setting new chapter position in multi-chaptered work to middle position correctly adjusts the other chapters' positions
    ...
    When I follow "Add Chapter"
      ...
      And I press "Post"
    Then I should see "Chapter 2"
      And I should see "Second Chapter (Not Third)"
    When I follow "Next Chapter"
    Then I should see "Chapter 3"
  ...
  Scenario: Setting a new chapter's position outside of total chapter range should append the chapter to the end or beginning
    ...
    When I follow "Add Chapter"
      ...
      And I press "Post"
    Then I should see "Chapter 3"
      And I should see "Way Out of Range (Positive)"
    When I follow "Add Chapter"
      ...
      And I press "Post"
    Then I should see "Chapter 1"
      And I should see "Way Out of Range (Negative)"
   When I follow "Add Chapter"
      ...
      And I press "Post"
   Then I should see "Chapter 1"
    And I should see "Not even a number!"