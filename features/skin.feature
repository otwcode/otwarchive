...
Feature: creating and editing skins
  ...
  Given PENDING ("Skins Admins should be able to see public skins in the admin skins page")
  Given the unapproved public skin "public skin"
  ...
  Given PENDING ("Skins Admins should not be able to edit unapproved skins")
  Given the unapproved public skin "public skin"
    And I am logged in as a Skins Admin
  When I go to "public skin" skin page
  Then I should not find "Edit"
  ...
  Given PENDING ("Skins Admins should be able to approve public skins")
  Given the unapproved public skin "public skin"
    And I am logged in as a Skins Admin
  When I go to the skins admin page
    And I check "public skin"
  ...
  Given PENDING ("Skins Admins should be able to edit but not delete public approved skins")
  Given the approved public skin "public skin" with css "#title { text-decoration: blink;}"
    And I am logged in as a Skins Admin
  When I go to "public skin" skin page
  Then I should see "Edit"
  ...
  Given PENDING ("Skins Admins should be able to unapprove public skins, which should also remove them from preferences")
  Given "skinuser" is using the approved public skin "public skin" with css "#title { text-decoration: blink;}"
