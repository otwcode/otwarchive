Feature: Manipulate work languages and locale languages on the Archive
  In order to be multicultural
  As an admin
  I'd like to be able to manipulate work languages and locale languages on the Archive

Scenario: An admin can add a work language
...
Scenario: An admin can add a locale language

  Given basic locale languages
    And I am logged in as a "translation" admin
  When I go to the locale_languages page
    And I follow "Add a Locale Language"
    And I fill in "Name" with "Klingon"
    And I fill in "Abbreviation" with "tlh"
    And I press "Create Locale Language"
  Then I should see "Locale language was successfully added."
    And I should see "Locale Languages"
    And I should see "Klingon"

Scenario: Adding Abuse support for a locale language
  ...
  When I am logged in as a "policy_and_abuse" admin
    ...
    # Locale languages are sorted by short name, so the first "Edit" is for Arabic
    And I follow "Edit"
...
Scenario: Adding a locale language to the Support form
  ...
  When I am logged in as a "support" admin
    And I go to the locale_languages page
    # Locale languages are sorted by short name, so the first "Edit" is for Sindarin
    And I follow "Edit"
