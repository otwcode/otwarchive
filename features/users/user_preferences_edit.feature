...
Feature: Edit preferences
 ...
 When I go to mywarning2's user page
  ...
  Scenario: Change browser page title format
  When I am logged in as "ewing3"
    And I post the work "Masterpiece" with fandom "Testing"
  Then I should see the page title "Masterpiece - ewing3 - Testing"
  When I go to my preferences page
    And I fill in "Browser page title format" with "Fandom - TITLE - author"
    And I press "Update"
  Then I should see "Your preferences were successfully updated"
  When I view the work "Masterpiece"
  Then I should see the page title "Testing - Masterpiece - ewing3"
