Feature: Blocking
  Scenario: Users can block from my blocked users page
    ...
    Then the page title should include "blocker - Blocked Users"
    When I fill in "blocked_id" with "pest"
      And I press "Block"
  ...
  Scenario: The blocked users page is paginated
    ...
    Then the page title should include "blocker - Blocked Users"
      And I should see "pest4" within "ul.pseud li:nth-child(1)"
    ...
    Then the page title should include "blocker - Blocked Users"
      And I should see "pest2" within "ul.pseud li:nth-child(1)"
