...
Feature: User dashboard
  ...
  # Add works to series
  When I edit the work "Oldest Work"
    And I check "series-options-show"
    And I fill in "work_series_attributes_title" with "Oldest Series"
    And I press "Post Without Preview"
  Then I should see "Oldest Series"
  When I edit the work "Work 2"
    And I check "series-options-show"
    And I fill in "work_series_attributes_title" with "Series 2"
    And I press "Post Without Preview"
  Then I should see "Series 2"
  When I edit the work "Work 3"
    And I check "series-options-show"
    And I fill in "work_series_attributes_title" with "Series 3"
    And I press "Post Without Preview"
  Then I should see "Series 3"
  When I edit the work "Work 4"
    And I check "series-options-show"
    And I fill in "work_series_attributes_title" with "Series 4"
    And I press "Post Without Preview"
  Then I should see "Series 4"
  When I edit the work "Work 5"
    And I check "series-options-show"
    And I fill in "work_series_attributes_title" with "Series 5"
    And I press "Post Without Preview"
  Then I should see "Series 5"
  When I edit the work "Newest Work"
    And I check "series-options-show"
    And I fill in "work_series_attributes_title" with "Newest Series"
    And I press "Post Without Preview"
  Then I should see "Newest Series"
  ...
  Then I should see "Recent series"
    ...
    And I should see "Series 2" within "#user-series"
    And I should see "Series 3" within "#user-series"
    And I should see "Series 4" within "#user-series"
    And I should see "Series 5" within "#user-series"
  ...
  # Create a pseud
  When "meatloaf" creates the pseud "gravy"
  ...
  When I go to the new work page
    ...
    And I select "gravy" from "work_author_attributes_ids_"
    And I check "series-options-show"
  ...
  When I follow "Oldest Work"
    And I follow "Bookmark"
    And I select "gravy" from "bookmark_pseud_id"
    And I press "Create"
  Then I should see "Bookmark was successfully created."
