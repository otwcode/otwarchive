Feature: Kudos Pagination
  ...
  Scenario: Three pages of kudos without javascript
    ...
    Then I should see "fan9, fan8, fan7, and 6 more users left kudos on this work!"
    When I follow "6 more users"
    Then I should see "1 - 3 of 9 User Kudos on Popular (9)"
      And I should see "fan1, fan2, and fan3 left kudos on this work!"
    When I follow "Next"
    Then I should see "4 - 6 of 9 User Kudos on Popular (9)"
      And I should see "fan4, fan5, and fan6 left kudos on this work!"
    When I follow "Next"
    Then I should see "7 - 9 of 9 User Kudos on Popular (9)"
      And I should see "fan7, fan8, and fan9 left kudos on this work!"
