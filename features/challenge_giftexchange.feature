...
Feature: Collection
  ...
  When I fill in "General Signup Instructions" with "Here are some general tips"
    ...
    And I select "2009" from "gift_exchange_signups_open_at_1i"
    And I select "2009" from "gift_exchange_signups_close_at_1i"
  ...
  # When I select "2009" from "gift_exchange_signups_open_at_1i"
  #   And I press "Submit"
