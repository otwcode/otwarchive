...
describe Users::PasswordsController do
  ...
  describe "GET #edit" do
    ...
    it "redirects with an error when providing an invalid token" do
      ...
      it_redirects_to_with_error(
        new_user_password_path,
        "This password reset link is invalid or expired. Please check your email for the most recent password reset link.<br>If it has been more than #{ArchiveConfig.PASSWORD_RESET_COOLDOWN_HOURS} hours, you can submit the password reset form again."
      )
    end
  end
end
