...
describe Admin::SupportNoticesController do
  ...
  let(:support_notice_params) { attributes_for(:support_notice, notice_content: "New notice content") }
  ...
  describe "POST #create" do
    ...
    it "creates admin activity" do
      ...
      expect(AdminActivity.last.summary).to include(support_notice_params[:notice_content])
    end
  ...
  describe "PUT #update" do
    ...
    let(:success) do
      expect { support_notice.reload }
        .to change { support_notice.notice_content }
  ...
  describe "DELETE #destroy" do
    ...
    it "creates admin activity" do
      ...
      expect(AdminActivity.last.summary).to include(support_notice.notice_content)
    end
