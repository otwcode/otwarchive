  ...
  describe "PUT #confirm_change_email" do
    ...
    context "when logged in" do
      ...
      it "disallows incorrect password" do
        ...
        expect(response).to render_template(:change_email)
        expect(flash[:error]).to include("Your old password was incorrect. Please try again or, if you've forgotten your password, log out and reset your password via the link on the login form. If you are still having trouble, contact Support for help.")
      end
