...
sudo "/usr/bin/redis-server  /etc/redis/redis2.conf" 
sudo "/usr/bin/redis-server  /etc/redis/redis3.conf"
sudo "/usr/bin/redis-server  /etc/redis/redis4.conf"
sudo "/usr/bin/redis-server  /etc/redis/redis5.conf"
sudo "/usr/bin/redis-server  /etc/redis/redis6.conf"
sleep 10
ps -ef |grep redis
