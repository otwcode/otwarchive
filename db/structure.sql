...
CREATE TABLE `admin_settings` (
  ...
  `disabled_support_form_text` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `audits` (
  ...
  `username` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `action` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `audited_changes` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `bookmarks` (
  ...
  `user_id` int(11) DEFAULT NULL,
  `bookmarker_notes` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `collection_profiles` (
  ...
  `faq` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rules` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `gift_notification` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `assignment_notification` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `delayed_jobs` (
  ...
  `handler` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `gift_exchanges` (
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `signup_instructions_general` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signup_instructions_requests` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signup_instructions_offers` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `questions` (
  ...
  `screencast` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `position` int(11) DEFAULT 1,
  PRIMARY KEY (`id`),
...
CREATE TABLE `series` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `summary` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `series_notes` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hidden_by_admin` tinyint(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `works` (
  ...
  `endnotes` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
