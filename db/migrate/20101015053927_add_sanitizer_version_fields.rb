class AddSanitizerVersionFields < ActiveRecord::Migration
  def self.up
    ...
    # call mysql directly so only copy table once
    ...
    execute "ALTER TABLE `chapters` ADD `content_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `notes_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `summary_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `endnotes_sanitizer_version` smallint DEFAULT 0 NOT NULL"
    ...
    execute "ALTER TABLE `collection_profiles` ADD `intro_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `faq_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `rules_sanitizer_version` smallint DEFAULT 0 NOT NULL"
    ...
    execute "ALTER TABLE `feedbacks` ADD `comment_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `summary_sanitizer_version` smallint DEFAULT 0 NOT NULL"
    ...
    execute "ALTER TABLE `gift_exchanges` ADD `signup_instructions_general_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `signup_instructions_requests_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `signup_instructions_offers_sanitizer_version` smallint DEFAULT 0 NOT NULL"
    ...
    execute "ALTER TABLE `series` ADD `summary_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `notes_sanitizer_version` smallint DEFAULT 0 NOT NULL"
    ...
    execute "ALTER TABLE `works` ADD `summary_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `notes_sanitizer_version` smallint DEFAULT 0 NOT NULL, ADD `endnotes_sanitizer_version` smallint DEFAULT 0 NOT NULL"
  end
