...
ibox.style.display="";ibox.style.display="none";posToCenter(ibox);ibox.style.display="visible";getElem('ibox_content').style.overflow="auto";var elemSrcId=url.substr(url.indexOf("#")+1,1000);var elemSrc=getElem(elemSrcId);if(elemSrc){strHTML=elemSrc.innerHTML;}
...
ibox.style.display="";ibox.style.display="none";posToCenter(ibox);ibox.style.display="visible";getElem('ibox_content').style.overflow="auto";var response=http.responseText;setIBoxContent(response);}}
