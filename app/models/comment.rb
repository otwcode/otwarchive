class Comment < ActiveRecord::Base
  ...
  validates_length_of :content, 
    ...
    :too_long => "must be less than " + ArchiveConfig.COMMENT_MAX.to_s + " letters long."

  def validate
    errors.add_to_base("This comment looks like spam to our system, sorry! Please try again, or create an account to comment.") unless check_for_spam
  end
