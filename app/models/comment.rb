class Comment < ActiveRecord::Base         
  ...
  ArchiveConfig.COMMENT_MAX = 4300
  ...
  validates_length_of :content, :maximum => ArchiveConfig.COMMENT_MAX, :message => "must be less than %d letters long.".t/ArchiveConfig.COMMENT_MAX
