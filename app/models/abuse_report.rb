class AbuseReport < ActiveRecord::Base
  ...
  validates :email, :email_veracity => true, :message => t('invalid_email', :default => 'appears to be invalid. Please use a different address or leave blank.'), :allow_blank => true
