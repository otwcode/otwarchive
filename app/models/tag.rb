class Tag < ApplicationRecord
  ...
  def syn_string=(tag_string)
    ...
    if new_merger && new_merger == self
      ...
      self.errors.add(:base, "<a href=\"#{Rails.application.routes.url_helpers.edit_tag_path(new_merger)}\">#{new_merger.name}</a> is not a canonical tag. Please make it canonical before adding synonyms to it.")
