module PromptRestrictionsHelper
  ...
  def prompt_restriction_settings(form, include_description = false)
    ...
    result += dt_wrapper(form.label(:optional_tags_allowed, t('prompt_restrictions_helper.optional_tags_allowed', :default => "Optional Tags?")) +
                          link_to_help("challenge-optional-tags"))
    result += dd_wrapper(form.check_box(:optional_tags_allowed))

    result += dt_wrapper(form.label(:description_allowed, t('prompt_restrictions_helper.description_allowed', :default => "Details/Description: ")))
    result += required_and_allowed_boolean(form, "description")

    result += dt_wrapper(form.label(:url_required, t('prompt_restrictions_helper.url_required', :default => "URL: ")))
    result += required_and_allowed_boolean(form, "url")
    
    result += dt_wrapper(form.label(:fandom_num_required, t('prompt_restrictions_helper.fandom_num_required', :default => "Fandom(s): ")))
    ...
    result += dt_wrapper(form.label(:category_num_required, t('prompt_restrictions_helper.category_num_required', :default => "Categories:")))
    result += required_and_allowed(form, "category")

    result += dt_wrapper(form.label(:freeform_num_required, t('prompt_restrictions_helper.freeform_num_required', :default => "Freeform(s):")))
    result += required_and_allowed(form, "freeform")

    result += dt_wrapper(form.label(:warning_num_required, t('prompt_restrictions_helper.warning_num_required', :default => "Archive Warning(s):")))
