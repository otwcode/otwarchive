class ChallengesController < ApplicationController
  ...
  # script/generate challenge WhatEver -- eg, script/generate challenge Flashfic, script/generate challenge BigBang, etc
  # This creates:
  # - a model called Challenge::WhatEver -- eg, Challenge::Flashfic, Challenge::BigBang, etc which actually implements a challenge
  ...
  # 
  # This feeds us into challenges/new and creates a new empty Challenge object with collection -> SGA_Flashfic 
  #   and implementation -> Challenge::Flashfic.new
  # We are then redirected to Challenge::FlashficController new ->  views/challenges/flashfic/new.html.erb
  #
  # These can have lots of options specific to flashfics, including eg how often prompts are posted, if they should automatically 
  ...
  def no_collection
    setflash; flash[:error] = t('challenge.no_collection', :default => "What collection did you want to work with?")
    redirect_to(request.env["HTTP_REFERER"] || root_path)
    false
  end

  def no_challenge
    setflash; flash[:error] = t('challenges.no_challenge', :default => "What challenge did you want to work on?")
