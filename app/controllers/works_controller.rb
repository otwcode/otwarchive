...
class WorksController < ApplicationController
  ...
  before_action :users_only, except: [:index, :show, :navigate, :search, :collected, :edit, :edit_tags, :update_tags, :drafts, :share]
  ...
  before_action :check_ownership, except: [:index, :show, :navigate, :new, :create, :import, :show_multiple, :edit_multiple, :edit, :edit_tags, :update_tags, :update_multiple, :delete_multiple, :search, :mark_for_later, :mark_as_read, :drafts, :collected, :share]
  # admins should have the ability to edit tags (:edit_tags, :update_tags) as per our ToS
  before_action :check_ownership_or_admin, only: [:edit, :edit_tags, :update_tags]
  ...
  def update_tags
    ...
    if params[:edit_button] || work_cannot_be_saved?
      render logged_in_as_admin? ? :edit : :edit_tags
    elsif params[:preview_button]
      @preview_mode = true
      @page_subtitle = t(".page_title")
      render :preview_tags
