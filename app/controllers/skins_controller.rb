class SkinsController < ApplicationController
  ...
  before_filter :load_skin, :except => [:index, :new, :create, :unset, :unapproved, :approved, :rejected, :admin_update]
  ...
  before_filter :check_permission_to_skin, :only => [:unapproved, :approved, :rejected, :admin_update]
  ...
  def admin_update    
    ...
    redirect_to unapproved_skins_path
  end
