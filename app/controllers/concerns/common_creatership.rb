...
# set the author attributes
  def set_author_attributes
    ...
    sorry = ts("You haven't selected any pseuds for this %{type}. Please use Remove Me As Author or consider orphaning your work instead if you do not wish to be associated with it anymore.", type: params[controller] )
