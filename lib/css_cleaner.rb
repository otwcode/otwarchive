...
module CssCleaner
  ...
  URI_REGEX = Regexp.new('https?://\w[\w\-\.]+\.(' + TOP_LEVEL_DOMAINS.join('|') + ')/[\w\-\.\/]*[\w\-]\.(' + ArchiveConfig.SUPPORTED_EXTERNAL_URLS.join('|') + ')')
  URL_REGEX = Regexp.new('"' + URI_REGEX.to_s + '"|\'' + URI_REGEX.to_s + '\'')
